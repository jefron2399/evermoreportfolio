...
<x-layout.app>
    ...
    style="background-image: url('{{ asset('images/background.jpg') }}'); background-size: cover; background-position: center; background-repeat: no-repeat; image-rendering: crisp-edges;">
...
<div class="relative z-10 flex flex-col items-center">
   <img src="{{ asset('images/profile.jpeg') }}" alt="Evermore" class="w-72 h-72 rounded-full border-4 border-gray-700 shadow-lg">
